  ...
  return (
    ...
    >
      <header className="space-y-2">
        ...
        <h1 className="text-3xl font-bold text-navy dark:text-white">About KickOff Hub</h1>
      ...
      <div className="space-y-4">
        <div className="rounded-xl border border-slate-200 bg-white/60 p-6 shadow-sm dark:border-slate-800 dark:bg-navy/60">
          <h2 className="text-lg font-semibold text-navy dark:text-white">Roadmap</h2>
        ...
        <div className="rounded-xl border border-slate-200 bg-white/60 p-6 shadow-sm dark:border-slate-800 dark:bg-navy/60">
          <h2 className="text-lg font-semibold text-navy dark:text-white">Tech stack</h2>
